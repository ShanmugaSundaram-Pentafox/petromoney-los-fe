...
export const particulars = [
  ...
  { key: 'existing_exposure_with_petromoney', label: 'Existing exposure with Pentafox (Rs)' },
  ...
  { key: 'date_of_login_of_file_with_petromoney', label: 'Date of Login of the file with Pentafox' },
  { key: 'business_vintage_with_omc_in_years', label: 'Business Vintage with OMC in Years' },
  { key: 'foir_prior_to_current_petromoney_exposure', label: 'FOIR prior to Current Pentafox Exposure' },
