...
import TextInput, { InputFieldWrapper, InputLabel } from '../../../components/TextInput/TextInput';
  ...
  return (
    <Box p={2}>
      <div className={classes.tabsWrapper}>
        ...
        >
          <Tab label={<InfoBox active={activeTab === 0} number={1} title="Dealer Info" />} {...tabA11yProps(0)} />
          <Tab label={<InfoBox active={activeTab === 1} number={2} title="Project Details" />} {...tabA11yProps(1)} />
          <Tab label={<InfoBox active={activeTab === 2} number={3} title="Roof Details" />} {...tabA11yProps(2)} />
          <Tab label={<InfoBox active={activeTab === 3} number={4} title="Electrical Assessments" />} {...tabA11yProps(3)} />
          <Tab label={<InfoBox active={activeTab === 4} number={5} title="Load Profile" />} {...tabA11yProps(4)} />
        </Tabs>
                ...
                <InputFieldWrapper>
                  ...
                  <div>
                    <FormControl component="fieldset">
                      <RadioGroup row aria-label="dealer_interest" name="dealer_interest" defaultValue="outrate">
                        <FormControlLabel
                          value="outrate"
